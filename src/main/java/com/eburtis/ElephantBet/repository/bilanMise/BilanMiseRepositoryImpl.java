...
import com.eburtis.ElephantBet.repository.bilanMise.BilanMiseRepositoryCustom;
...
public class BilanMiseRepositoryImpl implements BilanMiseRepositoryCustom {
    @PersistenceContext
    private EntityManager entityManager;

    /**
     * Requete de la liste des bilans de mise pour l'année
     * @param annee
     * @param parametrages
     * @return
     */
    ...
    public List<Object[]> listTicketPourAnnee(Integer annee, List<Parametrage> parametrages) {
        ...
        exclusionPourRequete.append("select staff_creator_group_name from bilan_mise where date_part('year', date_of_creation) = :annee" + " ");
    ...
    public List<Object[]> listTicketAvecPrixSuperieurALimitePourAnnee(Integer annee, Integer limite, List<Parametrage> parametrages) {
        StringBuilder exclusionPourRequete = new StringBuilder();
        exclusionPourRequete.append("select staff_creator_group_name, count(*), sum(ticket_price) from bilan_mise where ticket_price > :limite and date_part('year', date_of_creation) = :annee" + " ");
        if (!parametrages.isEmpty()) {
            for (Parametrage parametrage : parametrages) {
                String exclusion = "and ((date_of_creation not between" + " '" + parametrage.getDateDebutLimite().toString() + "' " + "and" + " '" + parametrage.getDateFinLimite().toString() + "')" +
                        " or ((date_of_creation between" + " '" + parametrage.getDateDebutLimite().toString() + "' " + "and" + " '" + parametrage.getDateFinLimite().toString() + "')" +
    ...
    public List<Object[]> listTicketPourMois(Integer annee, Integer mois, List<Parametrage> parametrages) {
        StringBuilder exclusionPourRequete = new StringBuilder();
        exclusionPourRequete.append("select staff_creator_group_name from bilan_mise where date_part('year', date_of_creation) = :annee and date_part('month', date_of_creation) = :mois"  + " ");
        if (!parametrages.isEmpty()) {
            for (Parametrage parametrage : parametrages) {
                String exclusion = "and ((date_of_creation not between" + " '" + parametrage.getDateDebutLimite().toString() + "' " + "and" + " '" + parametrage.getDateFinLimite().toString() + "')" +
                        " or ((date_of_creation between" + " '" + parametrage.getDateDebutLimite().toString() + "' " + "and" + " '" + parametrage.getDateFinLimite().toString() + "')" +
    ...
    public List<Object[]> listTicketAvecPrixSuperieurALimitePourMois(Integer annee, Integer mois, Integer limite, List<Parametrage> parametrages) {
        StringBuilder exclusionPourRequete = new StringBuilder();
        exclusionPourRequete.append("select staff_creator_group_name, count(*), sum(ticket_price) from bilan_mise where ticket_price > :limite and date_part('year', date_of_creation) = :annee and date_part('month', date_of_creation) = :mois" + " ");
        if (!parametrages.isEmpty()) {
            for (Parametrage parametrage : parametrages) {
                String exclusion = "and ((date_of_creation not between" + " '" + parametrage.getDateDebutLimite().toString() + "' " + "and" + " '" + parametrage.getDateFinLimite().toString() + "')" +
                        " or ((date_of_creation between" + " '" + parametrage.getDateDebutLimite().toString() + "' " + "and" + " '" + parametrage.getDateFinLimite().toString() + "')" +
    ...
    public List<Object[]> listTicketPourPeriode(LocalDate dateDebut, LocalDate dateFin, List<Parametrage> parametrages) {
        StringBuilder exclusionPourRequete = new StringBuilder();
        exclusionPourRequete.append("select staff_creator_group_name from bilan_mise where date_of_creation between :dateDebut and :dateFin"  + " ");
        if (!parametrages.isEmpty()) {
            for (Parametrage parametrage : parametrages) {
                String exclusion = "and ((date_of_creation not between" + " '" + parametrage.getDateDebutLimite().toString() + "' " + "and" + " '" + parametrage.getDateFinLimite().toString() + "')" +
                        " or ((date_of_creation between" + " '" + parametrage.getDateDebutLimite().toString() + "' " + "and" + " '" + parametrage.getDateFinLimite().toString() + "')" +
    ...
    public List<Object[]> listTicketAvecPrixSuperieurALimitePourPeriode(LocalDate dateDebut, LocalDate dateFin, Integer limite, List<Parametrage> parametrages) {
        StringBuilder exclusionPourRequete = new StringBuilder();
        exclusionPourRequete.append("select staff_creator_group_name, count(*), sum(ticket_price) from bilan_mise where ticket_price > :limite and date_of_creation between :dateDebut and :dateFin"  + " ");
        if (!parametrages.isEmpty()) {
            for (Parametrage parametrage : parametrages) {
                String exclusion = "and ((date_of_creation not between" + " '" + parametrage.getDateDebutLimite().toString() + "' " + "and" + " '" + parametrage.getDateFinLimite().toString() + "')" +
                        " or ((date_of_creation between" + " '" + parametrage.getDateDebutLimite().toString() + "' " + "and" + " '" + parametrage.getDateFinLimite().toString() + "')" +
