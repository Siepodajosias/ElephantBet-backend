...
@Table(name = com.eburtis.ElephantBet.domain.BilanMise.TABLE_NAME)
public class BilanMise {

    public static final String TABLE_NAME = "bilan_mise";
    ...
    public BilanMise(Ticket ticket) {
        ...
        this.dateWhenWon = ticket.getDateWhenWon();
        this.staffCreatorId = ticket.getStaffCreatorId();
        this.staffCreatorName = ticket.getStaffCreatorName();
        this.staffCreatorGroupId = ticket.getStaffCreatorGroupId();
        this.staffCreatorGroupName = ticket.getStaffCreatorGroupName();
        this.ticketStatus = ticket.getTicketStatus();
        this.staffPayGroup = ticket.getStaffPayGroup();
    }
     ...
     */
    public BilanMise(String ticketReference, LocalDate dateOfCreation, int ticketPrice, int amtWon,
